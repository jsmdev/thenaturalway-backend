...
- El contenido de Markdown se guarda en dos archivos:
  - `docs/PRD.md`: Versión en inglés (US English)
  - `docs/PRD-es.md`: Versión en español de España

**Criterios de Validación** (ver [QUALITY_GATES.md](../QUALITY_GATES.md#gate-1-prd-completion)):
- Todas las secciones requeridas están completas
- Product vision claramente definido
- Target audience identificado
- Todas las features listadas con prioridades
- Diagrama de contexto incluido (usando C4 model)
- Especificaciones técnicas definidas (agnósticas de tecnologías específicas)
- Ambos archivos (inglés y español) existen y están sincronizados
...
- Añadir un enlace a la incidencia en la sección de funcionalidades del archivo `docs/PRD.md` y `docs/PRD-es.md`
