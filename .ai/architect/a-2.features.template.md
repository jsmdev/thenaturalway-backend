...
Esta sección es obligatoria si la funcionalidad tiene una interfaz de usuario.
...
**No aplica**: Esta funcionalidad no requiere interfaz de usuario (solo API/backend).
