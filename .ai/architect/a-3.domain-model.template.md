...
<!--
Documenta las reglas de negocio importantes relacionadas con las entidades y relaciones.
Especifica restricciones, validaciones y comportamientos esperados.
-->

{{ for regla in reglasNegocio }}

### {{ regla.entidad | PascalCase }} - {{ regla.nombre }}

{{ regla.descripción | Una descripción clara de la regla }}

**Aplicación**: {{ regla.aplicación | Cuándo y cómo se aplica esta regla }}
...
<!--
Define los términos del dominio que pueden tener significados específicos en este contexto.
Esto ayuda a establecer un lenguaje ubicuo (Ubiquitous Language).
-->

{{ for termino in terminosDominio }}

- **{{ termino.nombre }}**: {{ termino.definición | Definición clara del término en el contexto del dominio }}
